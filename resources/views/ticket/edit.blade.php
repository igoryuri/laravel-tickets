            ...
            <div class="cell flex-align-self-center">
                <div class="card">
                    ...
                    <div class="card-content p-2">
                        <form action="{{ route('tickets.update', ['id' => $ticket->id]) }}" method="post" class="custom-validation"
                            ...
                            @if(Auth::user()->department_id !== 1)
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="cell-md-1">
                                        ...
                                        <input type="checkbox" data-role="switch" data-caption="Sim" name="change" id="change" {{old('change',$ticket->change) === 'on' ?'checked': ''}}>
                                    </div>
                                </div>
                            @else
...
@section('scripts')
    ...
    <script src="{{asset('js/category-load.js')}}"></script>
@endsection